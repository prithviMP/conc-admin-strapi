...
export interface ApiImportantlinkImportantlink extends Schema.CollectionType {
  collectionName: 'importantlinks';
  info: {
    singularName: 'importantlink';
    pluralName: 'importantlinks';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::importantlink.importantlink',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiLevelLevel extends Schema.CollectionType {
  ...
  attributes: {
    ...
    no_of_active_days: Attribute.BigInteger;
...
export interface ApiModuleModule extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    type: Attribute.Enumeration<['video', 'pdf', 'image', 'text']>;
    conetnt: Attribute.Media;
    levels: Attribute.Relation<
      'api::module.module',
      'manyToMany',
      'api::level.level'
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Content: Attribute.DynamicZone<
      ['posts.image', 'posts.poll', 'posts.video']
    >;
...
export interface ApiPurchasePurchase extends Schema.CollectionType {
  ...
  attributes: {
    ...
    course_start_date: Attribute.Date;
    purchase_end_date: Attribute.DateTime;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::importantlink.importantlink': ApiImportantlinkImportantlink;
